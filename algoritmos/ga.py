...
#     # Novo: para guardar as melhores rotas únicas
#     top_rotas = []
...
#         # Guardar todas as rotas únicas da geração com seus custos
#         for ind, custo in zip(pop, custos_pop[idx_sorted]):
#             if (tuple(ind), custo) not in top_rotas:
