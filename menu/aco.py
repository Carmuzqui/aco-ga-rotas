...
def render():
    ...
    # Seção de configuração dos parâmetros do ACO
    ...
    # Botão para executar o ACO com os parâmetros definidos
    if st.button("Executar ACO"):
        ...
        # Salva os parâmetros e resultados no estado da sessão para acesso rápido
    ...
    if "aco_resultado" in st.session_state:
        ...
        # Para cada rota selecionada, desenha o trajeto real no mapa utilizando a API do Google Directions
        for idx, rota_info in enumerate(resultado.get("top_3", [])):
            ...
            # Adiciona marcadores para cada cidade do trajeto
        ...
        # Gráfico de evolução do custo ao longo das iterações (convergência)
        fig = go.Figure()
